...
class CompareMobiles extends Component {
  constructor(props) {
    super(props);
    this.state = {
      searchmobile_list: [],
  ...
  render() {
    ...
    const menu = (
      <Menu style={{ background: "#000" }}>
        <Menu.Item><a onClick={() => this.props.history.push('/mobile/comparemobiless')} style={{ color: "#FFF", borderBottom: "solid #FFF 1px" }}>Mobiles</a></Menu.Item>
...
export default connect(mapStateToProps, mapDispatchToProps)(CompareMobiles);
